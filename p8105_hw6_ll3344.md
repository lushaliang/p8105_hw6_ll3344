...
``` r
set.seed(111)
boruta = Boruta(bwt ~ ., data = baby_df, doTrace = 2, maxRuns = 11)
```
...
```
    ...
    ## Boruta performed 10 iterations in 53.8103 secs.
    ##  No attributes deemed important.
    ##  No attributes deemed unimportant.
    ##  19 tentative attributes left: babysex, bhead, blength, delwt, fincome
    ## and 14 more;
...
```
    ...
    ##  6 2          36      52  3629   154      65 1        40.3 0             11
    ##  7 2          35      53  3345   127      65 2        39.7 0             14
    ##  8 2          36      56  3685   170      95 1        40.3 0             12
    ##  9 1          36      52  3629   152      45 1        39.6 0             11
    ## 10 1          36      54  3402   161      95 1        40.1 0             11
